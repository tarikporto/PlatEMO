...
for nsp_config_index = 1:length(nsp_configs)
    ...
    xlabel('geração');
    saveas(gcf, strcat('Figures/SPEA2DSD_f1_',strrep(num2str(nsp_config,'%1.1f'),'.',''),'_clusters_per_generation.png'));
end
...
saveas(gcf, strcat('Figures/SPEA2DSD_f1_resumo_clusters_per_generation.png'));
hold off